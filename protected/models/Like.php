 ...
 * @property integer $liked_at_time
...
class Like extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('blog_id, liked_at_time, status', 'numerical', 'integerOnly'=>true),
			array('user_id', 'length', 'max'=>11),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, blog_id, liked_at_time, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('liked_at_time',$this->liked_at_time);
